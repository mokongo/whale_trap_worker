# whale_trap_worker.py (Updated with /trap Telegram command polling)
import os
import time
import requests
import pandas as pd
...
def run_whale_trap_worker():
    ...
    while True:
        if check_for_trap_command():
            send_telegram_alert("✅ Whale Trap Worker received /trap command!")
